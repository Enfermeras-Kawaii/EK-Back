...
import { SolicitudModelTablet } from '../models/solicitanteTablet.model';
...
export const createSolicitudEmpleoTablet = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const solicitudEmpleo = await SolicitudModelTablet.create({
            id_solicitud,
            nombre,
            domicilio,
            genero,
